            ...
            <div className="swiper-wrapper">
              {
                upCommingLiveAuctionData.map((data) => {
                    ...
                    const formattedStartingBidPrice = formatCurrency(
                    currentLanguage === 'en' ? startingUsd : currentLanguage === 'th' ? startingThb : startingCny,
                    currentLanguage,
                    currencyType
                    );
                  return (
