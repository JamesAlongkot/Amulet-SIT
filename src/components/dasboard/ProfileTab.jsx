              ...
              <div className="row">
                ...
                <div className="col-12">
                  <div className="form-inner">
                    ...
                    <input type={openEye === 1 ? "text": "password"} name="password"  placeholder="Create A Password" />
                    <i className={openEye === 1 ? "bi bi-eye-slash bi-eye" :"bi bi-eye-slash"} id="togglePassword" onClick={handleEyeIcon} />
                  </div>
                </div>
                <div className="col-12">
                  <div className="form-inner mb-0">
                    <label>Confirm Password *</label>
                    <input type={openEye === 1 ? "text": "password"} name="password"  placeholder="Confor Password" />
                    <i className={openEye === 1 ? "bi bi-eye-slash bi-eye" :"bi bi-eye-slash"} id="togglePassword" onClick={handleEyeIcon} />
                  </div>
                </div>
                <div className="col-12">
