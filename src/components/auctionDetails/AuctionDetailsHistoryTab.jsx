          ...
          <div className="row d-flex justify-content-center g-4">
            <div className="col-lg-6 col-md-4 col-sm-10">
              <div className="eg-card auction-card1">
                ...
                <div className="auction-content">
                  <h4><Link href="/auction-details">Brand New royal Enfield 250 CC For Sale</Link></h4>
                  <p>Bidding Price : <span>$85.9</span> </p>
                  <div className="auction-card-bttm">
                    <Link href="/auction-details" className="eg-btn btn--primary btn--sm">Place a Bid</Link>
            ...
            <div className="col-lg-6 col-md-4 col-sm-10">
              <div className="eg-card auction-card1 wow fadeInDown">
                ...
                <div className="auction-content">
                  <h4><Link href="/auction-details">Wedding Special Exclusive Cupple Ring (S2022)</Link></h4>
                  <p>Bidding Price : <span>$85.9</span> </p>
                  <div className="auction-card-bttm">
                    <Link href="/auction-details" className="eg-btn btn--primary btn--sm">Place a Bid</Link>
                    <div className="share-area">
